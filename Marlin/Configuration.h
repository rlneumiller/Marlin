...
#define STRING_CONFIG_H_AUTHOR "(Arrel for Ender3V2 GD32F303RET6)" // Original author or contributor.
 ...
 */
 ...
 // TMC2208_STANDALONE when using gigadevice MCU, otherwise A4988 
 ...
 */
#define PSU_CONTROL
#define PSU_NAME "Power Supply Relay"
 ...
 */
// My printers use the 5 pin probe connector so we can free up the pin previously dedicated to the physical Z_MIN endstop switch.
...
/**
 * The BLTouch/CR-Touch probe uses a Hall effect sensor and emulates a servo.
 * CR-Touch is compatible with BLTouch settings; enable this for CR-Touch.
 */
#define BLTOUCH
